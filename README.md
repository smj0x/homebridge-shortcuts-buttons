...
| Display buttons as | `"Outlet" \| "Switch"` | `"Outlet"` | Display the shortcuts buttons as Outlets or as Switches. See the <a href="https://github.com/duddu/homebridge-shortcuts-buttons/tree/latest?tab=readme-ov-file#how-does-it-look-like">related documentation</a> for a visual preview of the two options in the Apple Home app. |
